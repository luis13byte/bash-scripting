...
sudo apt update && sudo apt install -y nmap net-tools yakuake colordiff htop docker.io mysql-client filezilla python3 gnupg software-properties-common curl terminator gparted git rkhunter virtualbox vagrant
